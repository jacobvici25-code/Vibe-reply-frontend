...
const s = {
  ...
  replyTag: { fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 24, letterSpacing: "-0.5px", lineHeight: 1.1, background: "linear-gradient(135deg, #e879f9, #818cf8, #38bdf8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" },
  subtitle: { fontSize: 12, color: "#6b7280", fontWeight: 400, marginTop: 2, letterSpacing: "0.5px", textTransform: "uppercase" },
  card: { background: "rgba(255,255,255,0.035)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 20, padding: "24px 20px", backdropFilter: "blur(20px)", boxShadow: "0 8px 40px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.06)", display: "flex", flexDirection: "column", gap: 20 },
  section: { display: "flex", flexDirection: "column", gap: 8 },
  label: { fontFamily: "'Syne', sans-serif", fontSize: 13, fontWeight: 600, color: "#a5b4fc", letterSpacing: "0.3px", display: "flex", alignItems: "center", gap: 6 },
  ...
  coachingWrap: { marginTop: 14, borderRadius: 12, overflow: "hidden", border: "1px solid rgba(124,58,237,0.25)" },
  coachingToggle: { width: "100%", background: "rgba(124,58,237,0.1)", padding: "10px 14px", display: "flex", justifyContent: "space-between", alignItems: "center", color: "#a78bfa", fontFamily: "'Syne', sans-serif", fontSize: 12, fontWeight: 700 },
  coachingContent: { background: "rgba(124,58,237,0.06)", padding: "14px", display: "flex", flexDirection: "column", gap: 12, animation: "slideDown 0.3s ease" },
  coachingItem: { display: "flex", flexDirection: "column", gap: 4 },
  coachingLabel: { color: "#7c3aed", fontSize: 11, fontWeight: 700, fontFamily: "'Syne', sans-serif", textTransform: "uppercase", letterSpacing: "0.5px" },
  coachingText: { color: "#94a3b8", fontSize: 13, fontFamily: "'DM Sans', sans-serif", lineHeight: 1.6 },
